export function journeyFormatter(str) {
    ...
    for (let index = 0; index < journeyData.travelTimes.length; index++) {
        ...
        journey += `${travelTime} minutes of travel between ${journeyData.postcodes[index]} and ${journeyData.postcodes[index + 1]}.\n${distance} miles of travel between ${journeyData.postcodes[index]} and ${journeyData.postcodes[index + 1]}.\n`
    }
    return journey
  }
